...
var heading = document.querySelector(".super_heading");
...
var button = document.querySelector(".submi");
...
button.addEventListener("click", function () {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      heading.innerHTML="recommendations from us :)"
